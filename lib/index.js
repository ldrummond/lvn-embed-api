    ...
    constructor(options) {
        ...
        if (rootElement) {
            ...
            const scrollingParam = (highlightOptions === null || highlightOptions === void 0 ? void 0 : highlightOptions.scrolling)
                ...
                : "";
            const secretParam = (highlightOptions === null || highlightOptions === void 0 ? void 0 : highlightOptions.secret)
                ? `&secret=${encodeURIComponent(highlightOptions === null || highlightOptions === void 0 ? void 0 : highlightOptions.secret)}`
                : "";
            const audioControlsParam = (highlightOptions === null || highlightOptions === void 0 ? void 0 : highlightOptions.audioControls)
                ? `&act=${encodeURIComponent(highlightOptions === null || highlightOptions === void 0 ? void 0 : highlightOptions.audioControls)}`
                : "";
            // Create Iframe
